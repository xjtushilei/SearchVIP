...
# 外部启动脚本: docker run --name xingchi -e JAVA_OPTS='-Xmx150m' -p 8081:8081 -v /data/h2/:/data/h2/ -d --restart=unless-stopped registry.cn-hangzhou.aliyuncs.com/scriptshi/xingchi